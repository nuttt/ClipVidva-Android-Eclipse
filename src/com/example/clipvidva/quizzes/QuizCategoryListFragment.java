 ...
 * interface.
 */
public class QuizCategoryListFragment extends ListFragment {
     ...
     */
    public QuizCategoryListFragment() {
    }

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        Log.v(this.getClass().getName(), "Created Data Source");
        CategoriesDataSource categoriesDataSource = new CategoriesDataSource(getActivity());
        categoriesDataSource.open();
        categories = categoriesDataSource.getAllQuizCategories();
